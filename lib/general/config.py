# Module used to store global configuration. Values are stored after reading
...
print 'Loading configDict'
dict_ = kp.Dictionary('configDict')
ROD = dict_.readOrDefault
...
#geomDictPath   = ROD('geomDictPath', '.')
#resultsDir     = ROD('resultsDir', caseDir)
