...
setup(
    ...
    name='planingfsi',  # Required
    # https://www.python.org/dev/peps/pep-0440/
    # https://packaging.python.org/en/latest/single_source_version.html
    version='0.1.0',  # Required
    # https://packaging.python.org/specifications/core-metadata/#summary
    description="Fluid-Structure Interaction for large deformation planing surfaces",  # Required
    # https://packaging.python.org/specifications/core-metadata/#description-optional
    long_description=long_description,  # Optional
    # https://packaging.python.org/specifications/core-metadata/#description-content-type-optional
    long_description_content_type='text/markdown',  # Optional (see note above)
    author="Matt Kramer",  # Optional
    author_email="matthew.robert.kramer@gmail.com",  # Optional
    ...
    classifiers=['License :: OSI Approved :: MIT License',
                 ...
                 'Topic :: Scientific/Engineering'],  # Optional
